...
import com.triippztech.freshtrade.service.ImageQueryService;
import com.triippztech.freshtrade.service.ImageService;
...
/**
 * REST controller for managing {@link com.triippztech.freshtrade.domain.Image}.
 */
@RestController
@RequestMapping("/api")
public class ImageResource {
    ...
    public ResponseEntity<Image> updateImage(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Image image)
    ...
    public ResponseEntity<Image> partialUpdateImage(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Image image)
        throws URISyntaxException {
