    ...
    <section className="hero py-6">
      <Container>
        ...
        <div className="hero-content">
          ...
          <div>
            <p className="text-muted mb-0">Effective date: June 13, 2021</p>
          </div>
        </div>
      </Container>
    </section>
      ...
      <Container>
        <Row>
          <Col xl="9" className="text-content">
            <p>
              FreshTrade (`&ldquo;`us`&ldquo;`, `&ldquo;`we`&ldquo;`, or `&ldquo;`our`&ldquo;`) operates the https://freshtrade.io website
              (the `&ldquo;`Service`&ldquo;`).
            </p>
            <p>
              This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service
              and the choices you have associated with that data. Our Privacy Policy for FreshTrade is created with the help of the{' '}
              <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Generator</a>.
            </p>
            <p>
              ...
              same meanings as in our Terms and Conditions, accessible from https://freshtrade.io
            </p>
            ...
            <p>
              ...
              contact or identify you (`&ldquo;`Personal Data`&ldquo;`). Personally identifiable information may include, but is not limited
              to:
            </p>
            ...
            <h4>Usage Data</h4>
            <p>
              We may also collect information how the Service is accessed and used (`&ldquo;`Usage Data`&ldquo;`). This Usage Data may
              include information such as your computer`&lsquo;`s Internet Protocol address (e.g. IP address), browser type, browser
            ...
            <hr />
            <h2>Use of Data</h2>
            <p>FreshTrade uses the collected data for various purposes:</p>
            <ul className="list-icon">
            ...
            <p>
              FreshTrade will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this
            ...
            <p>FreshTrade may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul className="list-icon">
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of FreshTrade</li>
            ...
            <p>
              We may employ third party companies and individuals to facilitate our Service (`&ldquo;`Service Providers`&ldquo;`), to
              provide the Service on our behalf, to perform Service-related services or to assist us in analyzing how our Service is used.
            </p>
            <p>
            ...
            <ul className="list-icon">
              <li>By email: support@freshtrade.io</li>
            </ul>
          </Col>
        </Row>
      </Container>
