...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freshtradeApp.country.delete.question">
        <Translate contentKey="freshtradeApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ft-confirm-delete-country" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
