...
export const UserProfileDeleteDialog = (props: IUserProfileDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freshtradeApp.userProfile.delete.question">
        <Translate contentKey="freshtradeApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ft-confirm-delete-userProfile" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
