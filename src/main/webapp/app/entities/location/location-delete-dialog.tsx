...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freshtradeApp.location.delete.question">
        <Translate contentKey="freshtradeApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ft-confirm-delete-location" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
