...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_LOCATION),
          REQUEST(ACTION_TYPES.UPDATE_LOCATION),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_LOCATION),
          REQUEST(ACTION_TYPES.DELETE_LOCATION),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_LOCATION),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_LOCATION actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_LOCATION),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_LOCATION),
          payload: resolvedObject,
        },
      ];
