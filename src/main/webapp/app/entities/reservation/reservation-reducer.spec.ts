...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_RESERVATION),
          REQUEST(ACTION_TYPES.UPDATE_RESERVATION),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RESERVATION),
          REQUEST(ACTION_TYPES.DELETE_RESERVATION),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_RESERVATION),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_RESERVATION actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RESERVATION),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_RESERVATION),
          payload: resolvedObject,
        },
      ];
