...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().location(DEFAULT_LOCATION).description(DEFAULT_DESCRIPTION);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().location(UPDATED_LOCATION).description(UPDATED_DESCRIPTION);
        return userProfile;
    }
    ...
    void getAllUserProfilesByLocationIsEqualToSomething() throws Exception {
        ...
        // Get all the userProfileList where location equals to DEFAULT_LOCATION
        defaultUserProfileShouldBeFound("location.equals=" + DEFAULT_LOCATION);

        // Get all the userProfileList where location equals to UPDATED_LOCATION
        defaultUserProfileShouldNotBeFound("location.equals=" + UPDATED_LOCATION);
    }

    @Test
    @Transactional
    void getAllUserProfilesByLocationIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where location not equals to DEFAULT_LOCATION
        defaultUserProfileShouldNotBeFound("location.notEquals=" + DEFAULT_LOCATION);

        // Get all the userProfileList where location not equals to UPDATED_LOCATION
        defaultUserProfileShouldBeFound("location.notEquals=" + UPDATED_LOCATION);
    }

    @Test
    @Transactional
    void getAllUserProfilesByLocationIsInShouldWork() throws Exception {
        // Initialize the database
        userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where location in DEFAULT_LOCATION or UPDATED_LOCATION
        defaultUserProfileShouldBeFound("location.in=" + DEFAULT_LOCATION + "," + UPDATED_LOCATION);

        // Get all the userProfileList where location equals to UPDATED_LOCATION
        defaultUserProfileShouldNotBeFound("location.in=" + UPDATED_LOCATION);
    }

    @Test
    @Transactional
    void getAllUserProfilesByLocationIsNullOrNotNull() throws Exception {
        // Initialize the database
        userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where location is not null
        defaultUserProfileShouldBeFound("location.specified=true");

        // Get all the userProfileList where location is null
        defaultUserProfileShouldNotBeFound("location.specified=false");
    }

    @Test
    @Transactional
    void getAllUserProfilesByLocationContainsSomething() throws Exception {
        // Initialize the database
        userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where location contains DEFAULT_LOCATION
        defaultUserProfileShouldBeFound("location.contains=" + DEFAULT_LOCATION);

        // Get all the userProfileList where location contains UPDATED_LOCATION
        defaultUserProfileShouldNotBeFound("location.contains=" + UPDATED_LOCATION);
    }

    @Test
    @Transactional
    void getAllUserProfilesByLocationNotContainsSomething() throws Exception {
        // Initialize the database
        userProfileRepository.saveAndFlush(userProfile);

        // Get all the userProfileList where location does not contain DEFAULT_LOCATION
        defaultUserProfileShouldNotBeFound("location.doesNotContain=" + DEFAULT_LOCATION);

        // Get all the userProfileList where location does not contain UPDATED_LOCATION
        defaultUserProfileShouldBeFound("location.doesNotContain=" + UPDATED_LOCATION);
    }
    ...
    void putNewUserProfile() throws Exception {
        ...
        updatedUserProfile.location(UPDATED_LOCATION).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.location(UPDATED_LOCATION).description(UPDATED_DESCRIPTION);
    ...
    void deleteUserProfile() throws Exception {
        ...
        restUserProfileMockMvc
            .perform(delete(ENTITY_API_URL_ID, userProfile.getId().toString()).accept(MediaType.APPLICATION_JSON))
