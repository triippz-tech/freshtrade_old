package com.triippztech.freshtrade.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.triippztech.freshtrade.IntegrationTest;
import com.triippztech.freshtrade.repository.timezone.DateTimeWrapper;
import com.triippztech.freshtrade.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ft_date_time_wrapper where id=%d", fieldName, id);
    }
